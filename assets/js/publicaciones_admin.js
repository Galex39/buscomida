...
function getPub(pagina){
	jQuery.ajax({
	  url: url+'index.php/Admin/Loby/Loby/getPub',
	  type: 'POST',
	  dataType: 'json',
	  data: {
	  			'pagina': pagina,
...
function seeMorePubInfo(){
	...
	jQuery.ajax({
	  url: url+'index.php/Admin/Loby/Loby/moreInformationPub',
	  type: 'POST',
	  dataType: 'json',
	  data: {'id_pub': id_pub},
	  success: function(data) {
...
function elimiarPub(puntero){
	...
	Swal.fire({
	  ...
	  if (result.value) {
	  	jQuery.ajax({
		  url: url+'index.php/Admin/Loby/Loby/eliminarPub',
		  type: 'POST',
		  data: {'id': id_pub},
		  success: function(data) {
...
function validarPublicacion(){
	jQuery.ajax({
	  url: url+'index.php/Admin/Loby/Loby/validarPublicacion',
	  type: 'POST',
	  dataType: 'json',
	  success: function(data) {
	    $.each(data, function () {
	    	let pubElim = this.pubElim;
			$(".cardPub").each(function(){
				let card = this;
	   			if ($(this).children(".card-body").children('input[type="hidden"]').val() == pubElim) {
	   				card.remove();
	   				jQuery.ajax({
	   				  url: url+'index.php/Admin/Loby/Loby/inactivarPub',
	   				  type: 'POST',
	   				  dataType: 'json',
	   				  data: {'id': pubElim},
	   				  success: function(data) {
