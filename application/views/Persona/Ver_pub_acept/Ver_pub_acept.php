...
<body id="page-top">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-12 text-center">
									<h2 class="section-heading text-uppercase">Donaciones Recibidas</h2>
									<h3 class="section-subheading text-muted">Aquí están las donaciones que has recibido</h3>
								</div>
							</div>
	...
	<!-- My jQuery code -->
	<script src="<?= base_url('assets/js/acept_pub.js') ?>"></script>
</body>
