...
<body id="page-top">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-12 text-center">
									...
									<h3 class="section-subheading text-muted">Aquí podrás encontrar todas las publicaciones realizadas el día de hoy</h3>
								</div>
							</div>
	...
	<!-- My jQuery code -->
	<script src="<?= base_url('assets/js/publicaciones_admin.js') ?>"></script>
